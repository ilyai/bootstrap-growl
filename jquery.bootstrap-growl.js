...
(function() {
	...
	$.bootstrapGrowl = function(message, options) {
		...
		$(".bootstrap-growl").each(
				function() {
					return offsetAmount = Math.max(offsetAmount, parseInt($(
							this).css(options.offset.from))
		...
		var close = function(e) {
			var $this, height;
			$this = $(this).is(".alert") ? $(this) : $(this).closest(".alert");
		...
		if (options.autoshrink) {
			$alert.on("bg.close", close);
			$alert.on("click", ".close", close);
		}
		return $alert;
	};
